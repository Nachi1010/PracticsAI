...
export const Features = () => {
  ...
  const features = {
    ...
    he: [
      {
        title: "™PracticsAI - הזדמנות היסטורית וחד פעמית",
        description: "ללמוד AI בחברת AI מובילה עם התחייבות חוזית לתעסוקה בתום ההכשרה",
      ...
      },
      {
        ...
        description: "המתמחים יעברו הכשרה מקיפה שבה נרכש ידע וניסיון מקביל ל-3 תארים אקדמיים + 2-3 שנות ניסיון",
      ...
      },
      {
        ...
        description: "פיתוח AI הוא מקצוע העתיד, המשכורות בתחום כבר כיום כפולות מהממוצע בהייטק.",
